...
const excelFiles = glob.sync('attached_assets/*ملف الزبائن*.xlsx');
console.log(`📁 وجدت ${excelFiles.length} ملف Excel`);
...
sample.forEach((customer, index) => {
  console.log(`${index + 1}. ${customer.name} - ${customer.phone_number}`);
});
